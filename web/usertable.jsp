<%-- 
    Document   : usertable
    Created on : 22 Dec, 2023, 10:39:18 AM
    Author     : 91915
--%>
...
<%@include file="adminsidebar.jsp" %>
 ...
 <%
   int counter = 1;
               ...
               String s="select fullname,email,qualification,phoneno,gender from  register where role='user'";
         ...
         %>
            ...
            <tr>
                     ...
                     <td><%= rs.getString(5) %></td>
                      <td><a href="editur.jsp?ur=<%=rs.getString(2)%>"><input type="submit" value="Edit" class="btn"> </a></td>
                     <td><a href="deleteur.jsp?ur=<%=rs.getString(2)%>"><input type="submit" value="Delete" class="btn"></a></td>
